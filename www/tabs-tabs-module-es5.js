...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tabs-tabs-module"], {
    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          ...
          "checkin-checkin-module").then(__webpack_require__.bind(null,
          /*! ../checkin/checkin.module */
          "./src/app/checkin/checkin.module.ts")).then(function (m) {
  ...
  function srcAppTabsTabsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_info_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../services/info.service */
    "./src/app/services/info.service.ts");

    var TabsPage = /*#__PURE__*/function () {
      function TabsPage(navCtrl, infoService) {
      ...
      _createClass(TabsPage, [{
        ...
        value: function navigate(opt, isURL) {
          ...
          this.navCtrl.navigateByUrl(link); // isURL ? this.cordovaBrowse(link) : this.navCtrl.navigate([link]);
        }
      }, {
        key: "ngOnInit",
