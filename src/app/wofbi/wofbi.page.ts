...
export class WofbiPage implements OnInit {
  ...
  tEvent: any = 'click';
  termsTooltip: string = 'I, the above designated, declare this information is true to the best of my knowledge. I am aware that if it is found to be untrue, I may be disqualified. I also agree to abide by the rules and regulations governing the Course.';
  detailsTooltip: string ='Please give details of your New Birth experience and state where and when it occurred';
